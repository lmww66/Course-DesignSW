...
> **💡 说明：** 以下为本项目的实物接线、功能演示及界面展示。

### 1. 整体硬件组装实物图
![整体硬件实物](picture/hardware_full.jpg)

### 2. 多级菜单与 OLED 交互界面
![菜单界面](picture/menu_ui.jpg)

### 3. MPU6050 动态波形 (DSO) 与计步测试
![波形与计步](picture/dmp_wave.jpg)

## 🛠️ 硬件物料清单

* **核心板**：STM32F103C8T6 最小系统板
* **显示模块**：1.3寸/0.96寸 OLED 屏幕 (IIC 接口)
* **姿态传感器**：MPU6050 (六轴加速度计+陀螺仪)
* **交互模块**：EC11 旋转编码器带按键
* **通信模块**：蓝牙串口模块 (HC-05 / JDY-31 等)
